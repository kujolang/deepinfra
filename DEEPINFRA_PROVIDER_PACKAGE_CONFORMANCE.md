# DeepInfra Provider Package Contract v1 Conformance

Evidence date: 2026-08-27. Contract: v1.0.1.

| Area | Result | Evidence |
|---|---|---|
| Native and compatible driver layers | PASS | `src/deepinfra.kujo`, `src/provider.kujo`; native inference is exposed separately |
...
| Remote release | PASS | `kujolang/deepinfra` tag `v0.1.0` and commit verified |
